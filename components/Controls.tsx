...
const Controls: React.FC<ControlsProps> = ({
  ...
  return (
    <div className="bg-gray-800 border-t border-gray-700 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.3)] z-20 flex flex-col transition-all duration-300">
            ...
            <div className={`${cardBaseClass} bg-gray-900 border-gray-700 justify-between`}>
                ...
                <div className="flex-1 flex flex-col justify-end pb-0.5">
                    <button
                        ...
                        className={`w-full py-2 px-3 rounded-md font-bold text-xs flex items-center justify-between transition-all ${
                        isBackingTrack
                    ...
                    >
                        ...
                        <div className={`w-2.5 h-2.5 rounded-full transition-colors ${
                            isBackingTrack ? 'bg-indigo-400 shadow-[0_0_8px_rgba(129,140,248,0.6)]' : 'bg-gray-600'
                        }`} />
                    </button>
                </div>
            </div>
            ...
            <div className={`${cardBaseClass} bg-gray-900 border-gray-700 justify-between`}>
                ...
                <div className="flex-1 flex flex-col justify-end pb-0.5">
                    <button
                        ...
                        className={`w-full py-2 px-3 rounded-md font-bold text-xs flex items-center justify-between transition-all group ${
                        isShuffle
                            ? 'bg-indigo-900/30 border border-indigo-500/50 text-indigo-300'
                            : 'bg-gray-800 border border-gray-700 text-gray-400 hover:border-gray-600'
                        }`}
                    >
                        ...
                        <div className={`w-2.5 h-2.5 rounded-full transition-colors ${
                            isShuffle ? 'bg-indigo-400 shadow-[0_0_8px_rgba(129,140,248,0.6)]' : 'bg-gray-600'
                        }`} />
                    </button>
                </div>
            </div>
