...
const CardDisplay: React.FC<CardDisplayProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col md:flex-row items-center justify-center gap-6 p-[2%] w-full h-full overflow-hidden">
      ...
      {/* Current Card */}
      <div className="relative flex-1 flex items-center justify-center min-h-0 min-w-0 transition-all duration-300 ease-in-out">
        <div className="relative flex flex-col items-center max-w-full max-h-full bg-gray-800 rounded-xl shadow-2xl border-2 border-indigo-500 overflow-hidden">
          ...
          <div className="flex-1 flex items-center justify-center bg-gray-800 relative min-h-0">
            {!currentImageError ? (
              <img
                src={currentUrl}
          ...
          <div className="bg-gray-900 p-3 text-center border-t border-gray-700 w-full">
